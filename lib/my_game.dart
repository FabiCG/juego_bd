...
class MyGame extends FlameGame with KeyboardEvents{
  ...
  void update(double dt) {
    ...
    if (vidas > 0) {
      ...
      if(TiempoFigura>TiempoGenerarFigura){
        ...
        //Se genera aleatoriamente una figura
  ...
  void actualizarText(){
    ...
    text[1].text="Mejor puntuaje: "+globals.pointers.points.toString();
    text[2].text="Intentos: "+vidas.toString();
  }
  ...
  void moverFiguraPoint(List<PositionComponent> figura){
    if(figura.isNotEmpty){
      for(int i=0;i<figura.length;i++){
        figura[i].y+=vel;
